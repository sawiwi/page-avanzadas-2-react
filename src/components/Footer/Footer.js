...
const Footer = () => (
  <footer className="bg-primary-700 pt-10 pb-10 xl:px-28">
    <div className="flex flex-wrap  mx-4 lg:mx-0">
        <div className="w-full h-full mt-10 mb-10 mx-10 xl:mx-0 xl:mt-0 sm:w-1/2 xl:w-4/12 3xl:w-5/12 3xl:my-14 ">
          <div className="w-5/6">
            <Link
              href="/"
              to=""
              className="w-96 px-2 text-[80px] xl:px-0 xl:text-[90px] text-center  text-secondary-700 font-extrabold font-customFont hover:text-secondary-opacity duration-200"
            >
              LOGO
            </Link>
            <div className="w-5/6">
            ...
            <div className="d-flex flex-col text-md text-secondary-700 mt-1">
                <div className="flex justify-start items-center my-3">
                  <a
                    ...
                    target='_blank'
                    className="text-dark bg-primary-400 text-secondary hover:bg-secondary-opacity hover:border-secondary mr-3 flex  h-16 w-16 items-center justify-center rounded-full border border-secondary hover:text-primary hover:bg-secondary duration-300 sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="25" height="30"
                      viewBox="0 0 8 16"
                  ...
                  <a
                    ...
                    className="text-dark bg-primary-400 text-secondary hover:bg-secondary-opacity hover:border-secondary mr-3 flex h-16 w-16 items-center justify-center rounded-full border border-secondary hover:text-primary hover:bg-secondary duration-300 sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg width="25" height="30" className="fill-current" viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/" preserveAspectRatio="xMidYMid">
                        <g>
                  ...
                  <a
                    ...
                    className="text-dark bg-primary-400 text-secondary hover:bg-secondary-opacity hover:border-secondary mr-3 flex  h-16 w-16 items-center justify-center rounded-full border border-secondary hover:text-primary hover:bg-secondary  duration-300 sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="30" className="fill-current" viewBox="0 5 1036 990">
      ...
      <div className="w-full h-full flex justify-start items-center sm:items-start flex-col sm:w-1/2  xl:w-8/12 3xl:w-7/12">
      <div className="w-5/6">
          <Link
            href="/"
            to=""
        ...
        <div className=" w-5/6">
          ...
          <div className="block h-56">
            <p className="flex text-md text-secondary-700 mt-5 mb-5 font-customFont items-center">
              <FaMapMarkerAlt className='m-1' />
              {/* <span className="font-bold text-secondary-800 font-customFont"></span>{' '} */}
              Asturias 171, Of. 101, Las Condes, Santiago
            </p>
            <p className="flex text-md text-secondary-700 mt-1 mb-5 font-customFont">
              <AiFillPhone className='m-1' /> +56
              264653732
            </p>

            <p className="flex text-md text-secondary-700 mt-2 font-customFont">
              <FiMail className='m-1' />
              contacto@unne.cl
            </p>  
          </div>
        </div>
